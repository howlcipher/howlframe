...
def test_seo():
    ...
    assert "HowlFrame" in parser.title, "HTML <title> must include HowlFrame"
    ...
    # 3. Canonical
    expected_canonical = "https://howlcipher.github.io/howlframe/"
    ...
    sitemap_target = (
        "Sitemap: https://howlcipher.github.io/howlframe/sitemap.xml"
    )
