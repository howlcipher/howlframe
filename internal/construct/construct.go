...
var table = []Entry{
	...
	{Name: "export", Support: Unsupported, Tracker: "improvements.md #95", Note: "ast.ResolveModules only unwraps export inside a top-level (module ...) child; a surviving export has no lowering"},
	...
	{Name: "module", Support: Unsupported, Tracker: "improvements.md #95", Note: "ast.ResolveModules only unpacks (module ...) children of the root, never a root that is itself a module"},
	...
	{Name: "use", Support: Unsupported, Tracker: "improvements.md #95", Note: "module import; the parser records it but no lowering resolves it"},
